            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
                ...
                <form wire:submit="submit" class="p-6 space-y-6">
                    ...
                    <div class="flex justify-end pt-4">
                        ...
                        >
                            <svg wire:loading.remove wire:target="submit" class="w-5 h-5 mr-2 -ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span wire:loading.remove wire:target="submit">Submit Nomination</span>
